...
function RequirementsEngineeringContent() {
    useI18nHTMLAttributes();
    const content = useIntlayer("requirements_engineering");
...
function RequirementsEngineering() {
    return (
        <RequirementsEngineeringContent />
    );
}
